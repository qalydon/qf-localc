...
def get_historical_price_data(ticker, category, for_date):
    """
...
if __name__ == '__main__':
    d = get_historical_price_data("ussbx", "mutualfund", "2018-11-30")
    print("ussbx", d)

    d = get_historical_price_data("mint", "etf", "2018-11-30")
    print("mint", d)

    d = get_historical_price_data("aapl", "", "2018-11-30")
    print("aapl", d)

    # Major indexes

    d = get_historical_price_data("djia", "index", "2018-11-30")
    print("DJIA", d)

    d = get_historical_price_data("spx", "index", "2018-11-30")
    print("S&P 500", d)

    d = get_historical_price_data("comp", "index", "2018-11-30")
    print("NASDAQ", d)